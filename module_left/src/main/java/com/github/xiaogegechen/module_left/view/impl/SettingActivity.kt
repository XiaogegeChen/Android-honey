...
import com.github.xiaogegechen.module_left.presenter.impl.SettingActivityPresenterImpl
...
class SettingActivity : BaseActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mListView?.adapter = SettingAdapter(getContext()!!, R.layout.module_left_setting_activity_list_item,
            DATA
        )
    ...
    override fun initData() {
        mSettingActivityPresenterImpl =
            SettingActivityPresenterImpl()
