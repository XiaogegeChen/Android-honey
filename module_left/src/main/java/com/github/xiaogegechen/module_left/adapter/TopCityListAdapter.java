...
/**
 * {@link com.github.xiaogegechen.module_left.view.impl.SelectCityActivity}中热门城市列表的adapter
 */
public class TopCityListAdapter extends RecyclerView.Adapter<TopCityListAdapter.ViewHolder> {
    ...
    public TopCityListAdapter(List<CityInfo> cityInfoList, Context context) {
        ...
        mSelectedBackgroundColor = context.getResources().getColor(R.color.module_left_weather_color_primary);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.module_left_activity_select_city_top_city_item, parent, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ViewHolder(@NonNull View itemView) {
            super(itemView);
            mTagTextView  = itemView.findViewById(R.id.module_left_activity_select_city_top_city_item_text);
        }
    }
