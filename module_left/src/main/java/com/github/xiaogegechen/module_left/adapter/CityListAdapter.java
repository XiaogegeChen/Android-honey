...
/**
 * {@link com.github.xiaogegechen.module_left.view.impl.SelectCityActivity}中模糊搜索城市列表的adapter
 */
public class CityListAdapter extends RecyclerView.Adapter<CityListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.module_left_activity_select_city_result_item, parent, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ViewHolder(@NonNull View itemView) {
            super(itemView);
            mTextView = itemView.findViewById(R.id.module_left_activity_select_city_result_item_text);
        }
    }
}
